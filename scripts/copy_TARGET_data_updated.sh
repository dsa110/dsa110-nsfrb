...
echo "delay to next ${3} pass in ${1} seconds"
sleep $1
reftime=$(date +%Y-%m-%d)
starttime=$(date)
...
sed -i '30s/$/ --realtimegp --savesearch/' /home/ubuntu/msherman_nsfrb/DSA110-NSFRB-PROJECT/tmp_run_proc_server_search_savesearch
...
sed -i "7s|.*|gptime\=\"${3}\"|" /home/ubuntu/msherman_nsfrb/DSA110-NSFRB-PROJECT/dsa110-nsfrb/scripts/save_realtime_GP_data.sh
...
echo "copying data to /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/"
sudo mkdir /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}
sudo mkdir /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
sudo cp /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/backup_raw_cands/*T??:??:??.???_input.npy /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
sudo cp /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/backup_raw_cands/*T??:??:??.???_searched.npy /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
for i in $(seq 1 $2);
do
	nowtime=$(date -d "$starttime +$i second" +%Y-%m-%dT%H:%M:%S) 
	sudo cp /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/init_cands/*/*${nowtime}* /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
	...
	sudo cp -r /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/final_cands/candidates/*${nowtime}* /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
	sudo ls /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/*${nowtime}.csv | xargs -n 1 tail -n +2 | cut -d ',' -f 1 | xargs -I {} sudo cp /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/init_cands/T4A/NSFRB{}.json /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
	sudo ls /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/*${nowtime}*.csv | xargs -n 1 tail -n +2 | cut -d ',' -f 1 | xargs -I {} sudo cp /dataz/dsa110/nsfrb/dsa110-nsfrb-candidates/init_cands/T4B/NSFRB{}.json /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
done

echo "copying fast visibilities"
./clear_realtime_GP_data.sh

sudo chown -R ubuntu:ubuntu /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
sudo chmod -R +rwx /dataz/dsa110/nsfrb/dsa110-nsfrb-followup/${3}/${reftime}_${3}/
systemctl --user start clearvis

td=$(bc -l <<< 86400.0-${1})
sf=$(bc -l <<< 86164.0905/86400.0)
ntd=$(bc -l <<< ${td}*${sf})
echo "delay to next ${3} pass in ${ntd} seconds"
