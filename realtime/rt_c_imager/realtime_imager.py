...
from nsfrb.config import NSFRB_PSRDADA_KEY,nsamps,NSFRB_CANDDADA_KEY,NSFRB_SRCHDADA_KEY,IMAGE_SIZE,DSAX_PSRDADA_KEY,corrs
"""
...
def main(args):
    ...
    while True:
        ...
        #    printlog(exc,output_file=rtlog_file)
        #    dat = np.nan*(np.ones((nsamps,4656,args.nchans_per_node,2))+1j*np.ones((nsamps,4656,args.nchans_per_node,2)))#continue
        ...
        if args.save:
            ...
            ifiles = np.array(glob.glob("/tmp/*T*_sb{:02d}.out".format(args.sb)))
