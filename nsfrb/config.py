...
flagged_corrs = []
bad_antennas = [49, 101, 71, 107, 116, 102, 105, 84]#,85,76,77,78,48,36,37,30]
...
rtbench_file = cwd + "/realtime/rt_c_imager/rttimes_log.txt"
rttx_file = cwd + "/realtime/rt_c_imager/rttx_log.txt"
...
rtmemory_file = cwd + "/realtime/rt_c_imager/rtmemory_log.txt"
